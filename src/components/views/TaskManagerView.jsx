...
export default function TaskManagerView({
  ...
  return (
    <div className="h-full flex flex-col bg-[#F2F4F7] p-4 lg:p-6 gap-6 overflow-hidden">
      <div className="shrink-0">
        <h1 className="text-2xl font-semibold text-gray-900 tracking-tight">Kế hoạch công việc</h1>
      </div>

      {/* Sub-navigation bar */}
      <div className="bg-white rounded-xl border border-slate-200 px-6 py-3 flex items-center justify-between shadow-sm z-0 relative shrink-0">
        <div className="flex items-center gap-1 bg-slate-100 p-1 rounded-xl">
          ...
          >
            {isAdmin ? 'Bảng công việc' : 'Công việc của tôi'}
          </button>
          <button 
