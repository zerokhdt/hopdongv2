    ...
    <div className="flex h-screen bg-white text-slate-800 font-sans overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden bg-white relative">
        ...
        <button
          ...
          className="absolute top-4 left-0 z-50 flex items-center justify-center p-1.5 bg-white border border-l-0 border-slate-200 rounded-r-lg shadow-sm text-slate-500 hover:text-blue-600 hover:bg-slate-50 transition-colors focus:outline-none"
        ...
        <main className="flex-1 overflow-hidden bg-[#F2F4F7]">
          ...
          {(activeTab === 'recruitment' || activeTab.startsWith('recruitment-')) && (
            <RecruitmentView 
              ...
              subTab={activeTab}
              onNavigateSubTab={(tabId) => setActiveTab(tabId)}
            />
          )}
          {activeTab === 'interview' && (
            <InterviewView 
